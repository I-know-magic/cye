...
//    static allowedMethods = [save: "POST", update: "PUT", delete: "DELETE"]
    ...
    def list() {
        ResultJSON result
        try {
            result = tenantService.queryTenantList(params)
    ...
    def save() {
        ResultJSON result
        try {
            Tenant tenant = new Tenant(params)
            result = tenantService.save(tenant)
        } catch (ServiceException se) {
            result = new ResultJSON(se.getCodeMessage(), false)
            LogUtil.logError(se, params)
        } catch (Exception e){
    ...
    def delete() {
        ResultJSON result
        try {
            result = tenantService.delete(params)
        } catch (ServiceException se) {
            result = new ResultJSON(se.getCodeMessage(), false)
            LogUtil.logError(se, params)
        } catch (Exception e){
