...
//    static allowedMethods = [save: "POST", update: "PUT", delete: "DELETE"]
    ...
    def list() {
        ResultJSON result
        try {
            result = posConfigService.queryPosConfigList(params)
    ...
    def create() {
        ResultJSON result
        try {
            result = posConfigService.create()
        } catch (ServiceException se) {
            result = new ResultJSON(se.getCodeMessage(), false)
            LogUtil.logError(se, params)
        } catch (Exception e){
    ...
    def edit() {
        ...
        try {
            String id = params.id;
            result = posConfigService.edit(id)
        } catch (ServiceException se) {
            result = new ResultJSON(se.getCodeMessage(), false)
            LogUtil.logError(se, params)
        } catch (Exception e){
    ...
    def save() {
        ResultJSON result
        try {
            PosConfig posConfig = new PosConfig(params)
            result = posConfigService.save(posConfig)
        } catch (ServiceException se) {
            result = new ResultJSON(se.getCodeMessage(), false)
            LogUtil.logError(se, params)
        } catch (Exception e){
    ...
    def delete() {
        ResultJSON result
        try {
            result = posConfigService.delete(params)
        } catch (ServiceException se) {
            result = new ResultJSON(se.getCodeMessage(), false)
            LogUtil.logError(se, params)
        } catch (Exception e){
