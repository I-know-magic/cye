...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="store" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="store" action="create"/>","库存表-增加");
            orderTable.formAction = "<g:createLink controller="store" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="store" action="edit"  />", "库存表-修改", id);
            orderTable.formAction = "<g:createLink controller="store" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="store" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    ...
    <th data-options="field:'storageId'">仓库Id</th>
    <th data-options="field:'goodsId'">商品Id</th>
    <th data-options="field:'quantity'">库存数量</th>
    <th data-options="field:'avgAmount'">成本</th>
    <th data-options="field:'storeAt'">出入库时间</th>
    <th data-options="field:'storeAmount'"></th>
        ...
        <div id="editWindow" class="easyui-dialog "
            ...
            <tr>
                <td class="title">仓库Id:</td>
                <td><input class="easyui-textbox" type="text" name="storageId" data-options="required:true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="title">成本:</td>
                <td><input class="easyui-textbox" type="text" name="avgAmount" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">出入库时间:</td>
                <td><input class="easyui-textbox" type="text" name="storeAt" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
