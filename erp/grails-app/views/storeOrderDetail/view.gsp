...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="storeOrderDetail" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="storeOrderDetail" action="create"/>","单据明细-增加");
            orderTable.formAction = "<g:createLink controller="storeOrderDetail" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="storeOrderDetail" action="edit"  />", "单据明细-修改", id);
            orderTable.formAction = "<g:createLink controller="storeOrderDetail" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="storeOrderDetail" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    ...
    <th data-options="field:'purchaseAmount'">单价</th>
    <th data-options="field:'quantity'">数量</th>
    <th data-options="field:'amount'"></th>
    <th data-options="field:'storeOrderId'">入库单Id</th>
    <th data-options="field:'goodsId'">商品Id</th>
        ...
        <div id="editWindow" class="easyui-dialog "
            ...
            <tr>
                ...
                <td><input class="easyui-textbox" type="text" name="purchaseAmount" data-options="required:true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input class="easyui-textbox" type="text" name="storeOrderId" data-options="required:true"/></td>
            </tr>
            <tr>
