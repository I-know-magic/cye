...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="checkOrder" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="checkOrder" action="create"/>","盘点单-增加");
            orderTable.formAction = "<g:createLink controller="checkOrder" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="checkOrder" action="edit"  />", "盘点单-修改", id);
            orderTable.formAction = "<g:createLink controller="checkOrder" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="checkOrder" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    ...
    <th data-options="field:'reallyQuantity'"></th>
