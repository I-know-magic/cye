...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink base=".." controller="goodsSpec" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink base=".."  controller="goodsSpec" action="create"/>", "商品口味-增加");
            orderTable.formAction = "<g:createLink base=".."  controller="goodsSpec" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink base=".."  controller="goodsSpec" action="edit"  />", "商品口味-修改", id);
            orderTable.formAction = "<g:createLink base=".."  controller="goodsSpec" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink base=".."  controller="goodsSpec" action="delete"  />");
        }
        function doSearch() {
            $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    <div class="table-list-r-1 fr" style="background:#b6b6b6;">
        <table id="mainGrid"
            ...
            <thead>
            <th data-options="field:'specName'">中文</th>
            <th data-options="field:'specName2'">英文</th>
            <th data-options="field:'price'">价格</th>
            %{--<th data-options="field:'crateBy'"></th>--}%
            ...
            <form id="editForm" method="post">
                <table cellpadding="5" style="table-layout:fixed;">
                    ...
                    <tr>
                        ...
                        <td><input class="easyui-textbox" type="text" name="specName" data-options="required:true"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="title">英文:</td>
                        <td><input class="easyui-textbox" type="text" name="specName2" data-options="required:true,validType:['nochina','length[1,50]']"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="title">价格:</td>
                        <td><input class="easyui-numberbox" type="text" name="price" id="price"
                                   data-options="required:true,min:0,precision:2,max:9999.99,missingMessage:'价格为必填项'"
                                   value="0"/>
                        </td>
                    </tr>
                    %{--<tr>--}%
                    %{--<td class="title">:</td>--}%
                    %{--<td><input class="easyui-textbox" type="text" name="crateBy" data-options="required:true"/></td>--}%
                    %{--</tr>--}%
                    %{--<tr>--}%
                    %{--<td class="title">:</td>--}%
