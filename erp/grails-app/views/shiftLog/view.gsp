...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="shiftLog" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="shiftLog" action="create"/>","-增加");
            orderTable.formAction = "<g:createLink controller="shiftLog" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="shiftLog" action="edit"  />", "-修改", id);
            orderTable.formAction = "<g:createLink controller="shiftLog" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="shiftLog" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    <div class="table-list-r-1 fr" style="background:#b6b6b6;">
        <table id="mainGrid"
            ...
            <thead>
                <th data-options="field:'userId'"></th>
    <th data-options="field:'userName'">登录帐号</th>
    <th data-options="field:'loginTime'"></th>
    <th data-options="field:'handoverTime'"></th>
    <th data-options="field:'shiftDate'"></th>
    <th data-options="field:'shiftName'"></th>
        ...
        <div id="editWindow" class="easyui-dialog "
            ...
            <tr>
                <td class="title">登录帐号:</td>
                <td><input class="easyui-textbox" type="text" name="userName" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="loginTime" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="handoverTime" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="shiftDate" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="shiftName" data-options="required:true"/></td>
            </tr>
