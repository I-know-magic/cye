...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="goodsUnit" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="goodsUnit" action="create"/>","商品单位-增加");
            orderTable.formAction = "<g:createLink controller="goodsUnit" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="goodsUnit" action="edit"  />", "商品单位-修改", id);
            orderTable.formAction = "<g:createLink controller="goodsUnit" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="goodsUnit" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    <div class="table-list-r-1 fr" style="background:#b6b6b6;">
        <table id="mainGrid"
            ...
            <thead>
                <th data-options="field:'unitCode'">编码</th>
    <th data-options="field:'unitName'">名称</th>
    <th data-options="field:'mnemonic'">助记码</th>
        ...
        <div id="editWindow" class="easyui-dialog "
            ...
            <form id="editForm" method="post">
                ...
                <td><input class="easyui-textbox" type="text" name="unitCode" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">名称:</td>
                <td><input class="easyui-textbox" type="text" name="unitName" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">助记码:</td>
                <td><input class="easyui-textbox" type="text" name="mnemonic" data-options="required:true"/></td>
            </tr>
