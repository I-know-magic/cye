...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="billPay" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="billPay" action="create"/>","-增加");
            orderTable.formAction = "<g:createLink controller="billPay" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="billPay" action="edit"  />", "-修改", id);
            orderTable.formAction = "<g:createLink controller="billPay" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="billPay" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    <div class="table-list-r-1 fr" style="background:#b6b6b6;">
        <table id="mainGrid"
            ...
            <thead>
                <th data-options="field:'billId'"></th>
    <th data-options="field:'billSeqNo'"></th>
    <th data-options="field:'payType'"></th>
    <th data-options="field:'payMoney'"></th>
    <th data-options="field:'exchange'"></th>
    <th data-options="field:'payTime'"></th>
    ...
    <th data-options="field:'branchId'"></th>
        ...
        <div id="editWindow" class="easyui-dialog "
            ...
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="billSeqNo" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
            ...
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="payMoney" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="exchange" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
                <td><input class="easyui-textbox" type="text" name="payTime" data-options="required:true"/></td>
            </tr>
            <tr>
                <td class="title">:</td>
