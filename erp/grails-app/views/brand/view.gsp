...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="brand" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="brand" action="create"/>","品牌-增加");
            orderTable.formAction = "<g:createLink controller="brand" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="brand" action="edit"  />", "品牌-修改", id);
            orderTable.formAction = "<g:createLink controller="brand" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="brand" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    ...
    <th data-options="field:'state'">状态：0正常1停用</th>
