...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            orderTable = new EasyUIExt($("#mainGrid"), "<g:createLink controller="busLog" action="list"  />");
        ...
        function myAdd() {
            orderTable.mainAdd("<g:createLink controller="busLog" action="create"/>","-增加");
            orderTable.formAction = "<g:createLink controller="busLog" action="save"  />";
        }
        function edit(id) {
            orderTable.mainEdit("<g:createLink controller="busLog" action="edit"  />", "-修改", id);
            orderTable.formAction = "<g:createLink controller="busLog" action="update"  />";
        }
        function del() {
            orderTable.mainDel("<g:createLink controller="busLog" action="delete"  />");
        }
        function doSearch() {
        $("#mainGrid").datagrid({
                queryParams: {
...
<div class="table-list">
    ...
    <th data-options="field:'busLogContent'">报文内容</th>
        ...
        <div id="editWindow" class="easyui-dialog "
            ...
            <tr>
                <td class="title">报文内容:</td>
                <td><input class="easyui-textbox" type="text" name="busLogContent" data-options="required:true"/></td>
            </tr>
