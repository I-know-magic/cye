...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $.post('<g:createLink base=".." controller='mainFrame' action='getInitInfo'/>?businessId='+businessId+"&type=1",function(data){
        ...
        function back(){
            location.replace("<g:createLink base=".." controller='mainFrame' action='initTenantInfo'/>?businessId="+businessId+"&provinceId="+provinceId+"&countryId="
...
<div class="wrap">
    ...
    <div class="monitor">
        ...
        <div class="monitor-box-txt"><p class="beizhu">系统将为您初始化分类数据，您可以在初始化完成后进行修改。</p></div>
