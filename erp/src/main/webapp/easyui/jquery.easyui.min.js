...
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_15a.prev());
if(hit.prev().length){
hit.prev().remove();
}
}
...
if(opts.autoHide){setTimeout(function(){tip.hide()},opts.autoHideDelay)}
},opts.showDelay);
};
...
$.fn.tooltip.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",autoHide:true,autoHideDelay:2000,showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,onOpen:function(){
...
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",cache:false,collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
function _2a1(){
...
$.messager.defaults=$.extend({},$.fn.window.defaults,{ok:"Ok",cancel:"Cancel",width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,closable:true,fn:function(){
}});
})(jQuery);
(function($){
...
var cmsg = "";
if(_460&&_460[2]){cmsg=_460[2]["msg"]?_460[2]["msg"]:""}
_45d(cmsg||opts.invalidMessage||_464);
if(_45a.validating){
_44e(_459);
}
return false;
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"该输入项为必填项",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_444,blur:_448,mouseenter:_44c,mouseleave:_44f,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
$(this).tooltip("destroy");
}},rules: $.extend({email:{validator:function(_46e){
...
return _474=="true";
},message:"Please fix this field."}},$validateRules),onBeforeValidate:function(){
...
$.ajax({url:data,data:_4dd,cache:false,dataType:"json",success:function(data){
_4de(data,fn);
},error:function(){
...
opts.onLoadSuccess.call(_4dc,data);if(fn) fn(data);
form.form("validate");
};
...
_4f4.filter(":not(:disabled):first").trigger("mouseover")
...
$.fn.form=function(_4f7,_4f8,fn){
if(typeof _4f7=="string"){
this.each(function(){
_4ee(this);
});
return $.fn.form.methods[_4f7](this,_4f8,fn);
}
return this.each(function(){
_4ee(this,_4f7);
_4ea(this);
...
$.fn.form.defaults={fieldTypes:["combobox","combotree","combogrid","datetimebox","datebox","combo","datetimespinner","timespinner","numberspinner","spinner","searchbox","numberbox","textbox"],novalidate:false,ajax:true,url:null,queryParams:{},onSubmit:function(_4fb){
...
//cell.css("text-align",(col.halign||col.align||"center"));
...
_6b9.filter(":first").trigger("mouseover")
...
if(col.formatter){
cc.push(col.formatter(_75f,_75c,_75b,col._dicKey));
}else{
cc.push(_75f);
}
}
...
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().next().addClass("tree-folder-open");
...
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"key",textField:"value",groupField:null,groupFormatter:function(_991){
return _991;
...
var opts=$(this).combobox("options");
if(!opts.url && !opts.dicKey){
return false;
}
var url = opts.url;
if(opts.dicKey){
url = _dic_key_url+"?dicKey="+opts.dicKey;
}
$.ajax({type:opts.method,url:url,data:_992,dataType:"json",success:function(data){
_993(data);
},error:function(){
