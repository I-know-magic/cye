function bindClickFns(){
    ...
    $("#searchByParams").click(function(){
        $(".saleDayDiv").slideToggle('slow');
    });
    //关闭检索框
    $(".closeSaleDayDiv").click(function(){
        $(".saleDayDiv").slideUp('slow');
    });
    //按条件检索采购进货单
    $(".saleDayParams").click(function(){
        searchSaleDay();
        $(".saleDayDiv").slideUp('slow');
    });
    //重置查询条件
