...
-- ----------------------------
-- Table structure for 登录账号 默认一条数据
-- ----------------------------
CREATE TABLE `s_user` (
...
CREATE TABLE `s_res` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='系统资源'
-- ----------------------------
-- Table structure for 操作
-- ----------------------------
CREATE TABLE `s_operate` (
  ...
  `memo` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='操作定义'
-- ----------------------------
-- Table structure for 权限
-- ----------------------------
CREATE TABLE `s_privilege` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_s_privilege_s_res1_idx` (`res_id`) USING BTREE,
  KEY `fk_s_privilege_s_operate1_idx` (`op_id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='权限定义表'
-- ----------------------------
-- Table structure for 角色权限
-- ----------------------------
...
CREATE TABLE `s_user_role_r` (
  ...
  KEY `fk_s_user_role_r_s_role1_idx` (`role_id`) USING BTREE,
  KEY `fk_s_user_role_r_sys_user1_idx` (`user_id`) USING BTREE,
...
-- ----------------------------
-- Table structure for goods_bar 条码
-- ----------------------------
...
-- ----------------------------
-- Table structure for store_order 出入库单据
-- ----------------------------
...
-- ----------------------------
-- Table structure for check_order_detail 盘点单明细
-- ----------------------------
...
-- ----------------------------
-- Table structure for store 实际库存
-- ----------------------------
...
-- ----------------------------
-- Table structure for store_account 库存流水 库存变化，台账
-- ----------------------------
...
DELIMITER ;;
CREATE   FUNCTION `currval_today`(seq_name VARCHAR(50)) RETURNS int(11)
    DETERMINISTIC
BEGIN
 DECLARE v INTEGER;
         DECLARE dt DATE;
...
DELIMITER ;;
CREATE   FUNCTION `nextval_today`(seq_name VARCHAR(50)) RETURNS int(11)
    DETERMINISTIC
BEGIN
		 DECLARE dtCurrent DATE;
         SET dtCurrent = CURRENT_DATE();
...
DELIMITER ;;
CREATE   FUNCTION `setval_today`(seq_name VARCHAR(50), VALUE INTEGER) RETURNS int(11)
    DETERMINISTIC
BEGIN
		 DECLARE dtCurrent DATE;
         SET dtCurrent = CURRENT_DATE();
